...
const Brand = () => {
  return (
    <div className="max-w-[340px] md:max-w-[95%] lg:max-w-[70%] m-auto bg-white md:mt-20 border">
      <h1 className="md:text-[40px] md:w-[85%]  mx-6">Brand Guidelines</h1>
      <p className="md:text-3xl mx-6 md:w-[85%] md:py-4">Logo</p>
      <div className="grid grid-cols-2 w-[85%] place-items-center gap-10 md:mx-6 ">
      ...
      {/* section2 */}
      <p className="md:text-3xl mx-6 md:w-[85%] md:py-4">Clearspace</p>
      <div className="grid grid-cols-2 w-[85%] place-items-center gap-10 md:mx-6 ">
        <div className="md:w-[65%] lg:w-[90%] md:ml-10 lg:ml-20  pb-7">
      ...
      {/* section3 */}
      <p className="md:text-3xl mx-6 md:w-[85%] md:py-4">Avoid these uses</p>
      <div className="grid grid-cols-2 w-[85%] place-items-center gap-10 md:mx-6 ">
        <div className="md:w-[65%] lg:w-[90%] md:ml-10 lg:ml-20  pb-7">
