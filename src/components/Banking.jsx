...
const Banking = () => {
  return (
    <div className="w-full bg-[#e0eaf6]  pt-[10px] md:pt-[10px] lg:pt-[0px]">
      <div className="max-w-[340px] md:max-w-[95%] lg:max-w-[70%] m-auto py-10 grid md:flex">
        <div className=" pt-11 flex flex-col justify-center md:w-[70%] items-center">
          <div className="md:mr-9">
            <h1 className="w-[80%] text-4xl md:w-[100%] md:text-[41px] lg:text-6xl">
        ...
        <div className="w-[100%] md:w-[50%] py-6 md:py-0 flex justify-center   ">
          <img src={phone3} alt="" />
        </div>
      </div>
    </div>
